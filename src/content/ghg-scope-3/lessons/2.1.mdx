...
<FormulaBox>
Category 6 Emissions = Σ [Distance (km) × Passenger Count × Emission Factor (tCO₂e/passenger-km)]
</FormulaBox>
...
An important technical consideration for air travel is **radiative forcing (RF)** — non-CO₂ warming effects from aviation including contrail formation, cirrus cloud enhancement, and NOx chemistry. These effects may increase the effective warming impact of aviation by a factor of 2–4× compared to CO₂ alone. The GHG Protocol allows but does not require companies to apply an RF uplift factor. However, many leading reporters and frameworks (including some SBTi guidance) recommend applying an uplift of approximately 2× for air travel to reflect the full climate impact.
...
<CalculationExercise
  ...
  solution="5,570 km × 0.429 kgCO₂e/passenger-km = 2,389.5 kgCO₂e = 2.39 tCO₂e. Compare to the same trip in economy class: 5,570 × 0.148 = 824 kgCO₂e = 0.82 tCO₂e — business class emits nearly 3× as much because it occupies more floor space per seat."
/>
