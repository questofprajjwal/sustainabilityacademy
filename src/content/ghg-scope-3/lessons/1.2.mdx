...
<FormulaBox>
Category 2 Emissions = Capital Expenditure (£/$/€) × EIO Emission Factor (tCO₂e per £/$/€)

OR

Category 2 Emissions = Mass or quantity of capital good × Physical emission factor (tCO₂e per unit)
</FormulaBox>
