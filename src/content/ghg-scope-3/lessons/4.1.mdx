...
<FormulaBox>
Category 13 Emissions = Σ [Lessee Energy Consumption (MWh) × Grid Emission Factor (tCO₂e/MWh)]
                      + Σ [Lessee Fuel Consumption × Fuel Emission Factor]
</FormulaBox>
...
<FormulaBox>
Category 13 Emissions (buildings) = Leased Floor Area (m²) × Energy Intensity (kWh/m²/year) × Grid Emission Factor (tCO₂e/MWh) ÷ 1,000
</FormulaBox>
