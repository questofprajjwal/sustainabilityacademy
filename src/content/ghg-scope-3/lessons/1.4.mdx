...
<FormulaBox>
Category 4 Emissions (fuel-based) = Fuel Consumed (litres or kg) × Fuel Emission Factor (tCO₂e/litre or kg)
</FormulaBox>
...
<FormulaBox>
Category 4 Emissions (distance-based) = Mass (tonnes) × Distance (km) × Emission Factor (tCO₂e/tonne-km)
</FormulaBox>
...
<FormulaBox>
Warehousing Emissions = Floor Space (m²) × Time (days) × Energy Intensity (kWh/m²/day) × Grid Emission Factor (tCO₂e/kWh)
</FormulaBox>

## Reducing Category 4 Emissions

Once measured, Category 4 data supports decisions on:
- **Mode shift**: Switching from air to ocean freight can reduce per-tonne-km emissions by 50–100×
