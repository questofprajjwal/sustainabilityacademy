...
<FormulaBox>
Category 11 (Energy-Using Products) = Units Sold × Product Lifetime (years) × Annual Energy Use (kWh/unit/year) × Emission Factor (tCO₂e/kWh)

OR for vehicles:

Category 11 = Units Sold × Lifetime Km Driven × Fuel Economy (litres/km) × Fuel Emission Factor (tCO₂e/litre)
</FormulaBox>
