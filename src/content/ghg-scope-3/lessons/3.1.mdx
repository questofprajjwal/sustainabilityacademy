...
<FormulaBox>
Category 9 Emissions = Σ [Mass (tonnes) × Distance (km) × Emission Factor (tCO₂e/tonne-km)]
</FormulaBox>

### Fuel-Based Method
<FormulaBox>
Category 9 Emissions = Fuel Consumed (litres or kg) × Fuel Emission Factor (tCO₂e/litre or kg)
</FormulaBox>
