...
<FormulaBox>
Category 3 T&D Loss Emissions = Purchased Electricity (MWh) × T&D Loss Rate × Grid Emission Factor (tCO₂e/MWh)

Category 3 Upstream Fuel Emissions = Fuel Consumed (unit) × Upstream Emission Factor (tCO₂e/unit)
</FormulaBox>
