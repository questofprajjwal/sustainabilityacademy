...
<FormulaBox>
Scope 3 Category 1 Emissions = Activity Data × Emission Factor

Where:
  Activity Data = mass (tonnes) of purchased good, OR spend (£/$/€) on purchased category
  Emission Factor = tCO₂e per tonne of good (average-data), OR tCO₂e per £/$/€ of spend (spend-based)
</FormulaBox>
