...
PE_AS,y = sum over k and t of (E_P,t,k,y + E_ap,t,k,y)

Where:
*   PE_AS,y = total GHG emissions at the application stage in year y (tCO2e)
*   E_P,t,k,y = emissions from processing of biochar type t for application type k in year y (tCO2e)
*   E_ap,t,k,y = emissions from utilization of biochar type t for application type k in year y (tCO2e)
...
LE_y = LE_as,y + LE_bd,y + LE_ts,y + LE_tap,y

Where:
*   LE_y = total leakage emissions in year y (tCO2e)
*   LE_as,y = leakage from activity shift
*   LE_bd,y = leakage from biomass diversion
*   LE_ts,y = leakage from transportation of waste biomass from sourcing site to production facility
*   LE_tap,y = leakage from transportation of biochar from production facility to application site
</FormulaBox>
