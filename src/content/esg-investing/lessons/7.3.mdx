...
WACI = Sum of `(Portfolio Weight) × (Company Carbon Emissions / Company Revenue)`

Provides a snapshot of how carbon-intensive the overall portfolio is, normalized by revenue.
</FormulaBox>
