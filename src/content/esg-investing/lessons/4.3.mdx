...
A growing area of fixed income engagement involves **green bonds** and **sustainability-linked bonds (SLBs)**. These instruments directly link the financing terms to the issuer's ESG commitments — either by ring-fencing proceeds for eligible green projects, or by adjusting the coupon rate based on whether the issuer meets pre-agreed sustainability targets. Fixed income investors engaging with issuers around these instruments are, in effect, embedding ESG expectations directly into the financial structure of the relationship.
...
As the PRI notes: "The process of portfolio monitoring has value protection and enhancement potential in itself, as a systematic approach for identifying material ESG issues, setting objectives and regularly tracking progress. It enables GPs to identify anomalies and achievements; support regular engagement with the portfolio company on these issues; and strengthen company reporting practices."
...
Real estate investors face growing evidence that ESG quality is financially material to returns. Research has shown that ESG factors positively affect the financial performance of equity real estate studies in the majority of cases, with evidence of a return spread between top-decile and bottom-decile properties by sustainability benchmarks such as the Global Real Estate Sustainability Benchmark (GRESB).
...
- A coalition of 29 investors representing approximately US$3.7 trillion in assets wrote to the Brazilian government in 2020, noting that Brazilian sovereign bonds would be considered high risk if Amazon deforestation continued, and flagging the possibility of divestment. Whether this had any practical effect remains unclear — Amazon destruction continued to rise in the period that followed
...
Despite these challenges, the trajectory is clear. Stewardship codes are extending their scope explicitly to all asset classes — not just listed equity. Institutional investors are developing asset-class-specific engagement frameworks. And regulators are increasingly expecting investors to demonstrate that stewardship principles are applied consistently across their entire investment activity, not just the portion held in public equities.

<HighlightBox>
**Key takeaway:** Stewardship principles — preserve and enhance long-term value through active ownership — are universal. The tools, counterparts, and levers vary significantly by asset class. In equities, the focus is on voting rights, board engagement, and shareholder resolutions. In fixed income, the leverage lies primarily at issuance and through creditor dialogue. In private equity, direct board influence is available through the GP relationship. In real assets and sovereign debt, engagement operates through manager relationships and investment decisions. Effective stewardship requires understanding which levers apply in each context — and using them with skill and persistence.
</HighlightBox>
