...
Once a client has clarity on their own beliefs, the real challenge begins: translating those beliefs into mandates that fund managers can actually act on. This is where the rubber meets the road.

The beliefs need to be operationalised — turned from philosophical positions into investable parameters. The ICGN Model Mandate Initiative, which proposes best practices for ESG-aware investment mandates, identifies four core areas where this operationalisation needs to occur:
...
The six dimensions across which leading institutions operationalise their ESG beliefs — spanning the investment mandate itself, investment beliefs and strategy, tools and processes, resources, performance management, and public reporting — provide a useful checklist for any asset owner designing a comprehensive ESG investment programme.
