...
<FormulaBox>
Weighted-Average Carbon Intensity (WACI) at the Portfolio Level:

WACI = Sum over all holdings i of:
(Current Value of Investment_i / Current Portfolio Value) × (Issuer Scope 1 + Scope 2 GHG Emissions_i / Issuer US$m Revenue_i)

Source: TCFD Implementation Guidance

This metric measures a portfolio's exposure to carbon-intensive companies on a revenue-normalised, position-weighted basis. It is the standard TCFD-recommended metric for portfolio-level carbon risk disclosure.
</FormulaBox>
...
| ESG Constraint | Typical Tracking Error Impact |
|----------------|------------------------------|
...
| Best-in-class ESG tilt | Low to moderate (40-80 bps) |
...
As shown in the formula above, WACI measures a portfolio's revenue-normalised carbon exposure. It is the standard TCFD metric for reporting portfolio-level climate risk. UK TCFD reporting focuses on Scope 1 and Scope 2 emissions; EU SFDR accounting extends this to Scope 3 (indirect value chain emissions). Scope 3 remains the most difficult to measure and is subject to significant estimation uncertainty.
...
**Portfolio-level ESG analytics dashboards**: Many managers now upload their portfolios to third-party ESG analytics platforms that provide a composite view of ESG exposure, controversy risk, carbon intensity and sector-level ESG comparisons. These platforms vary in sophistication: the more advanced ones combine multiple third-party data sources with proprietary ratings to reduce overreliance on any single provider.
...
## EU Regulatory Context: SFDR and Its Implications

The EU's **Sustainable Finance Disclosure Regulation (SFDR)** has introduced a mandatory classification system for investment products that has direct implications for how ESG portfolios are constructed and described:

- **Article 9 ("dark green") funds**: Have sustainable investment as their primary objective and must meet strict "Do No Significant Harm" (DNSH) criteria across all environmental objectives
- **Article 8 ("light green") funds**: Promote ESG characteristics as one factor among many, without sustainable investment being the defining objective; expected to cover the majority of ESG-labelled investment products in Europe
- **Article 6 funds**: Do not actively promote sustainability but must explain how they consider sustainability risks in their investment process

For portfolio managers, SFDR creates a direct link between investment strategy and mandatory disclosure obligations. A fund classified as Article 9 must demonstrate that its holdings genuinely advance sustainable objectives without causing significant harm to other sustainability goals. This requires more granular portfolio-level ESG data and more robust methodology than simply applying an ESG screen.

**Principal Adverse Impact (PAI) indicators** — a set of standardised environmental and social metrics that must be reported at the portfolio level under SFDR — are pushing managers toward more systematic ESG data collection. Key indicators include weighted average carbon intensity, exposure to companies in fossil fuel activities, and gender pay gap metrics across holdings.

The EU SFDR represents the most significant regulatory development in ESG portfolio management in recent years. While it primarily applies to European-domiciled funds and managers, its influence is spreading globally as international investors and fund selectors increasingly reference SFDR classification in their due diligence.
...
6. **Regulatory compliance**: Align reporting with SFDR, TCFD and other applicable frameworks
