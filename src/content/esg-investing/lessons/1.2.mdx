...
<AnalogyBox>
A biodiverse ecosystem is like a diversified investment portfolio, the more species it contains, the more resilient it is to shocks. Monocultures (like single-crop agriculture) are like concentrated portfolios, efficient in good times but catastrophically fragile when something goes wrong. A wheat farm with no crop rotation or genetic diversity can be wiped out by a single fungal outbreak, just as a single-stock portfolio can be wiped out by one company's failure. Biodiversity is nature's version of portfolio diversification.
</AnalogyBox>
