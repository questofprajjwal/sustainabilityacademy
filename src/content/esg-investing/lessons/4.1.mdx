...
<HighlightBox>
**Key takeaway:** Stewardship is not simply voting at AGMs, and engagement is not merely sending letters. Both are expressions of fiduciary responsibility, the active, deliberate exercise of ownership rights to preserve and enhance long-term value on behalf of clients and beneficiaries. Successful engagements rarely happen after a single meeting; persistence over many months, and willingness to escalate through the full ladder of tools when needed, is what separates effective stewardship from the appearance of it.
</HighlightBox>
