...
There are seven core motivations for ESG integration, and most firms are driven by a combination of several. The definitions and approaches discussed in this lesson are grounded in the **Principles for Responsible Investment (PRI)**, the UN-backed global framework with over 5,000 signatories, widely regarded as the defining standard for responsible investment practice.
...
Large asset owners, sovereign wealth funds, major pension funds such as Norway's Government Pension Fund Global or Japan's GPIF, own such a broad cross-section of the global economy that they cannot hedge away systemic risks. If climate change, biodiversity loss, or social instability drags down the entire economy, a diversified mega-owner loses everywhere simultaneously.

These **Universal Owners** have a direct financial incentive to address systemic ESG risks at the portfolio level, not just at the individual security level. They cannot simply sell out of the problem, the problem is too large and too pervasive. This gives them a distinct motivation for ESG integration that smaller, more concentrated investors do not share.
...
Survey data illustrates both the adoption and the gaps: roughly 82% of investors in one major global study reported using ESG information when making investment decisions. But adoption is not uniform, a meaningful share of investors, particularly in fixed income, still do not integrate ESG systematically. Among non-adopters, the most commonly cited barrier is the lack of reliable, comparable non-financial data.
