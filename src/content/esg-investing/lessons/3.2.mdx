...
The most important thing a board does is nothing that appears in formal minutes or committee reports — it is the quality of the conversation that happens when important decisions need to be made. Getting that quality right starts with having the right people in the room.

**Board composition** refers to the mix of skills, experience, and perspectives around the boardroom table. A well-composed board brings:

- Industry-relevant operating experience — ideally from multiple people, since no single director will always be available
- Financial expertise sufficient to interrogate management's numbers and capital allocation decisions
- Strategy and transformation experience
- Risk management understanding, increasingly including ESG-related risks such as climate and cyber
- External perspectives from adjacent industries or public policy backgrounds

Skills need to be **refreshed over time**. The needs of a business evolve as strategy changes. Skills themselves have a half-life — a director who was a technology expert a decade ago may no longer be current. Good nominations committees actively manage board composition against a forward-looking skills matrix.

<ExampleBox>
**Example: BHP's board skills disclosure**

Mining company BHP's annual report discloses its board's skill coverage across dimensions including mining operations, oil and gas, global experience, strategy, risk management, commodity value chains, financial expertise, public policy, health/safety/environment, technology, and capital allocation. Out of eleven directors, all eleven were assessed as bringing risk management expertise, nine brought strategy experience, and seven brought global experience and capital allocation skills — while only two had technology expertise, highlighting a potential gap the board was actively managing. This kind of granular, self-assessed disclosure allows investors to form their own view of whether the board is appropriately equipped for the company's current challenges.
</ExampleBox>
...
That said, formal independence criteria exist for good reasons. Questions about independence arise when a director:

- Was previously a senior executive of the company, with insufficient time having passed since departure
- Receives payments from the company beyond normal director fees
- Has close family ties with senior management or major shareholders
- Holds cross-directorships that create mutual dependency with other board members
- Is a nominee or representative of a significant shareholder
- Has served on the board for long enough that familiarity may have replaced critical distance
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Belgium, France, Spain, India</td>
    </tr>
    <tr>
      <td>8–10 years</td>
      <td>Explanation required</td>
      <td>UK, Singapore, Indonesia, Ireland</td>
    </tr>
    <tr>
      <td>12–15 years</td>
      <td>No longer independent (rule)</td>
      <td>Denmark, Greece, Slovenia</td>
    </tr>
    <tr>
      <td>Not addressed</td>
...
Gender, race, age, professional background, nationality, and cultural heritage each tend to bring different analytical perspectives, which in turn tends to produce more robust challenge and debate. A number of markets have moved towards quotas for female directors — Norway pioneered this approach — and most major markets are moving towards an expectation that at least 30% of public company directors are women.
...
Pay is where the sharpest conflict of interest between management and shareholders becomes visible. Executives want to be paid well; shareholders want to pay only for genuine performance that creates long-term value. Remuneration committees sit in the middle, trying to design structures that align these interests — while navigating the reality that competitive benchmarking tends to push pay levels upward over time.

### The Four Components of Executive Pay

In most markets, the pay package for senior executives has four elements:

1. **Fixed salary** — the base, typically adjusted annually. Controversial when it rises faster than general wage inflation, particularly given growing investor attention to CEO-to-worker pay ratios (now required disclosure in the UK and USA).

2. **Benefits and pension** — including pension contributions, which are often calculated as a percentage of salary. Investor concern here focuses on cases where executives receive significantly more generous pension terms than the broader workforce.

3. **Annual bonus** — paid at the end of the performance year, calculated against **key performance indicators (KPIs)** set at the start. These KPIs will predominantly be financial (profit-related), but around 20% will often reflect personal performance objectives or non-financial metrics — including, increasingly, ESG factors. Some portion of the bonus may be deferred for two to three years.

4. **Long-term incentive plan (LTIP)** — share-based awards that vest after a performance period of at least three years and are then subject to a holding period, meaning the overall lock-up can extend to five years or more. Performance for LTIPs is typically measured by a combination of **total shareholder return (TSR)** and **earnings per share (EPS)**. Equity linkage is the primary mechanism for aligning management interests with long-term shareholder value.
...
<ExampleBox>
**Example: The tensions around executive pay**

Investors often look at pay outcomes relative to share price performance — if the share price has fallen significantly, a large bonus payment feels particularly poorly calibrated. But companies and their remuneration committees often see it differently: the pay is contractually due if specific metrics were met, and those metrics may reflect real operational progress even if the share price underperformed due to broader market conditions. This fundamental difference in perspective — investors judging pay by overall returns, executives and boards judging it by contracted metric achievement — is a persistent source of tension that governance has not yet fully resolved.
</ExampleBox>
...
- **Materiality thresholds** — the quantitative level below which the auditor focused little attention. A performance materiality threshold at 50–60% of overall materiality (versus the typical 75%) may indicate lower auditor confidence in the company's own internal controls.
