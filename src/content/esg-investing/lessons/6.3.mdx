...
**EU Climate Transition Benchmarks (CTBs)** must meet these minimum requirements:
- At least 30% lower carbon intensity than the parent benchmark index
- The portfolio must follow a decarbonisation trajectory aligned with the Paris Agreement goals
- A minimum annual decarbonisation rate of 7% in carbon intensity

**EU Paris-Aligned Benchmarks (PABs)** impose stricter requirements:
- At least 50% lower carbon intensity than the parent benchmark
- Exclusions of companies significantly exposed to fossil fuels (coal, oil, gas extraction and generation)
- A minimum annual decarbonisation rate of 7% from a lower starting point than CTBs
- Alignment with a 1.5°C warming scenario

<HighlightBox>
The EU CTB and PAB labels are not just marketing designations — they are legally defined under EU regulation, with specific minimum thresholds and annual reporting requirements. An index fund that claims to be "Paris-aligned" must meet these standards in the EU context. This regulatory clarity is a significant step toward reducing greenwashing in the index space.
</HighlightBox>
