...
## Screening Strategies: The Three Core Approaches

Screening represents the oldest and most widely implemented form of ESG integration. Three primary screening types have evolved over time:
...
A company that is systematically violating any of these norms — for example, through persistent bribery of government officials or use of child labour — would be screened out regardless of its sector.

Norms-based screening is particularly powerful in institutional mandates because it grounds exclusions in legitimate, globally recognised standards rather than subjective value judgements. This makes the approach more defensible to a diverse beneficiary base.
...
All three screening approaches — negative, positive and norms-based — translate readily to listed equities. Additionally, hedge fund strategies are increasingly adopting ESG. A quantitative long-short equity strategy might go long the top ESG-rated companies in each sector while shorting the bottom-rated companies, generating return from the ESG differential while maintaining market and sector neutrality.
...
|-----------|-------------|
| **Green bonds** | Proceeds fund environmental projects (renewable energy, green buildings) |
| **Social bonds** | Proceeds fund social projects (affordable housing, healthcare, microfinance) |
| **Sustainability bonds** | Proceeds fund a mix of green and social projects |
| **Sustainability-linked bonds (SLBs)** | Coupon tied to the issuer meeting specific ESG KPIs |
| **Transition bonds** | Fund high-carbon industries transitioning to greener operations |
| **Blue bonds** | Fund ocean and marine conservation projects |
...
Infrastructure is notable for having one of the highest levels of ESG integration progress among alternative asset classes. This is intuitive: infrastructure assets are physical, long-lived, and often directly linked to environmental outcomes (energy generation, water treatment, transportation). Community impact and regulatory environment are central to the investment thesis of most infrastructure assets.
...
Hedge funds have historically shown the lowest level of ESG integration, driven by several structural features:

- Preference for an unconstrained investment universe to maximise alpha generation potential
- Short-term investment horizons for many strategies that reduce the relevance of long-term ESG risks
- Difficulty applying ESG to synthetic instruments (derivatives, short positions, swaps) which lack a direct "issuer ESG profile"
- Operational capacity constraints at smaller hedge fund firms

That said, progress is being made. Industry organisations and investor initiatives have published guidance on embedding ESG within hedge fund due diligence. Long-short equity hedge funds have found ways to integrate ESG signals, particularly carbon intensity data and ESG ratings, into their quantitative screens. The short side of a long-short book, in particular, can be used as a tool for expressing negative ESG views — short-selling the worst ESG-rated companies in each sector.

### Emerging Markets

Emerging markets present a distinctive ESG challenge. Data coverage is thinner, disclosure standards are weaker, and governance risks are often more pronounced. At the same time, emerging markets are disproportionately exposed to climate physical risks — many rapidly growing economies are located in geographically vulnerable regions.

**Governance** tends to be the most relevant and measurable ESG dimension in emerging markets, with country-level data from the World Bank WGI system providing a foundation for sovereign debt analysis. For equities, sector-specific ESG data is improving but remains less comprehensive than in developed markets.

A structural bias is important to acknowledge: applying developed-market ESG standards wholesale to emerging market issuers will systematically favour developed-market exposure, reducing portfolio diversification and potentially misrepresenting the genuine ESG improvement trajectories of emerging market companies.

<HighlightBox>
ESG screening works differently across asset classes — not because the principles change, but because data availability, ownership rights, and risk materiality vary. The most effective ESG portfolio construction recognises these differences and calibrates the approach accordingly, rather than applying a single methodology uniformly across all assets.
</HighlightBox>
...
**Unintended factor tilts**: Exclusions are rarely factor-neutral. Excluding tobacco companies, for example, removes a set of companies with high dividend yields and stable cash flows — which introduces an unintended value and income factor tilt. Similarly, excluding high-carbon companies tends to tilt a portfolio toward technology and growth stocks.
