...
**Attribution Factor = Outstanding Amount / Company Value**
...
**(Number of shares held by FI / Total shares) × Total equity of investee**
...
**Total Financed Emissions = Σ (Attribution Factor_c × Company Emissions_c)**
