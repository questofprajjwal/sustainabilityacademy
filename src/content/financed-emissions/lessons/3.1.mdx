...
**Financed Emissions = Σ (Outstanding Amount_v / Total Value at Origination_v) × Annual Emissions_v**
...
**Annual BEV Emissions = Annual kWh consumed × Grid emission factor (tCO2e/MWh)**
