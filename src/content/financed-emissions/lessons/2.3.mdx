...
**Attribution Factor = Outstanding Amount (Investment) / (Total Project Equity + Total Project Debt)**

For equity, the outstanding amount is:

**(Shares held by FI / Total project shares) × Total project equity**
...
**Attribution Factor = Outstanding Amount / Total Project Value at Origination**
