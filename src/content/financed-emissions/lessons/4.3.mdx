...
**Option 3a (Revenue-based, Score 3)**: Requires the company's revenue to calculate:

*Emissions = Company Revenue × Sector GHG Emissions / Sector Revenue*

This approach is the most company-specific of the three proxy methods and is generally preferred when revenue data is accessible.

**Option 3b (Asset-based, Score 4)**: When revenue data is unavailable, asset-based estimates use:

*Emissions = Outstanding Amount × (Sector GHG Emissions / Sector Total Assets)*

This is less specific than 3a but captures the scale of the company's operations relative to its sector peers.

**Option 3c (Asset-turnover-based, Score 4)**: Bridges between asset and revenue intensity:

*Emissions = Outstanding Amount × Asset Turnover Ratio × (Sector GHG Emissions / Sector Revenue)*
