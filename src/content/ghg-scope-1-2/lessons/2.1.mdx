...
Scope 2 is conceptually simple - purchased energy times an emission factor - but the dual reporting requirement, boundary rules, and certificate interactions add real complexity. Before you touch a calculator, make sure you can answer three questions for every facility: What energy did we purchase? What certificates or contracts do we hold? And does this market require dual reporting?

The next lesson walks through the actual calculation step by step, from electricity bills to final Scope 2 totals.
