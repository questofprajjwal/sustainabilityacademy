...
<HighlightBox>
The boundary decision is one of the most important choices you make early in the engagement. Whatever boundary you set here, you follow it for every single data point in the report. If subsidiaries do not have data, do not include them in the boundary. Chalk it out upfront - it prevents painful problems later.
</HighlightBox>
...
**Ignoring challenges.** A Chairman's message that only celebrates wins feels like marketing, not leadership communication. Acknowledging challenges - a target that was missed, a supply chain issue being addressed - builds credibility.
