...
Each section has its own set of natural questions. Once you get comfortable with this method, you will find that you can map out an entire report's content in an afternoon - just by writing questions for every chapter. The writing itself then becomes a matter of research and answering, which is far less intimidating than staring at a blank page.
