...
**Ensuring consistency across the report.** AI writes one section at a time. It does not track what was said in other sections. Ensuring that data is consistent, that terminology is uniform, and that the theme carries through - that is your job.
