...
Taxonomy Alignment % = Market Value of Taxonomy-aligned investments / Market Value of all investments × 100%

Where "Taxonomy-aligned investments" = investments in companies, projects, or assets whose economic activities meet:
(1) Substantial contribution to at least one of the six Taxonomy environmental objectives
(2) Do No Significant Harm to the remaining five objectives (using Taxonomy DNSH criteria)
(3) Minimum social safeguards (ILO Core Labour Standards, UNGC, UNGPs)
(4) Technical screening criteria as specified in Commission Delegated Regulation (EU) 2021/2139 and subsequent acts
</FormulaBox>
...
- **Turnover-based**: The proportion of the portfolio company's revenue from Taxonomy-aligned activities × the portfolio's investment value
- **CapEx-based**: The proportion of the portfolio company's capital expenditure on Taxonomy-aligned activities × the portfolio's investment value
- **OpEx-based**: The proportion of the portfolio company's operational expenditure on Taxonomy-aligned activities × the portfolio's investment value
