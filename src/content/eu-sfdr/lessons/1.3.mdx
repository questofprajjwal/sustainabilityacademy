...
Article 5 of SFDR requires financial market participants and financial advisers to include in their remuneration policies information demonstrating that those policies are **consistent with the integration of sustainability risks**. This obligation is deceptively simple in its statutory formulation but has significant practical implications for how firms structure their compensation frameworks.
