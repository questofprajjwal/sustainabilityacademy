...
The RTS (Recital 11) clarifies that products can promote E/S characteristics in various ways:
...
7. **PAI consideration at product level**: Whether PAI are considered, and if so, how. Article 8 products do not need to mandatorily report PAI at the product level (unlike Article 9 products), but must state whether they consider PAI.
