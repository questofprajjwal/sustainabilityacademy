...
SFDR's entity-level disclosures must be published on the firm's website. This is not simply a channel-of-publication requirement — the website is the primary anchor point for SFDR transparency, and the regulation and RTS set specific requirements for content, presentation, accessibility, and maintenance of website disclosures. Understanding these requirements in detail is essential for compliance.
...
<AnalogyBox>
The pre-contractual disclosure (prospectus or KID) is like the brief product summary on a product label. The website disclosure is like the detailed product page that gives you the full specification sheet. The periodic report is like the annual review of how the product actually performed. All three should be consistent, but each serves a different purpose and level of depth.
</AnalogyBox>
