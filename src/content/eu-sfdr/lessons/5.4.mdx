...
Maintain a template library containing the current RTS Annex templates (II, III, IV, V, VI, VII, VIII, IX) and track template updates when the RTS is amended. Assign template owners responsible for populating each template type.
