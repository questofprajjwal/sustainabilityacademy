...
Beyond the 14 mandatory PAI indicators in Table 1 and the mandatory sovereign and real estate indicators in Tables 4 and 5, the RTS provides an extensive set of **optional additional PAI indicators** in Tables 2 and 3. Firms can select any number of these indicators to supplement their mandatory reporting. This lesson explains the optional indicator framework, discusses criteria for selecting indicators, and examines the due diligence obligations that underpin the PAI consideration requirement.
