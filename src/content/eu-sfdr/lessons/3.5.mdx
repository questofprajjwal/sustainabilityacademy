...
The PAI statement is the primary output of the entity-level PAI consideration obligation. It is a formal, publicly disclosed document that brings together all PAI indicator data for a reference period, along with contextual information on the FMP's approach to PAI, actions taken, and targets set. The RTS prescribes detailed requirements for the content, format, and timing of this statement.
