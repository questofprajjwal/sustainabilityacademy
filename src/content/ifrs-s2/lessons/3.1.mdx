...
**(b) Risks with significant potential for material adjustment** — Any climate-related risk that could realistically force a significant change to the recorded book value of an asset or liability within the *next* annual reporting period must be disclosed. For example, if a coastal facility might need to be written down due to updated flood-risk maps, this must be stated. This mirrors the requirements for significant estimation uncertainty in financial reporting.
