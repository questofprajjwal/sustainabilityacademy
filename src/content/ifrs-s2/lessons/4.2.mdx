...
Paragraph 26 applies an efficiency principle: if a company uses the same enterprise process to track climate risk, water risk, and human rights risk, it can describe that process once and point out the climate-specific details — rather than duplicating the description for each topic. For example, if climate risks are managed on an integrated basis with other sustainability risks (e.g., water risk, biodiversity risk), the entity need not provide separate risk management disclosures for each topic. An integrated description — clearly indicating which elements apply to climate — is sufficient.
