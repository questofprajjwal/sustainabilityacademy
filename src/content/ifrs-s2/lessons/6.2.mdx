...
The data reveals a significant gap: active strategies carry more than 2× lower financed emissions than passive strategies, despite managing comparable AUM — reflecting that active managers can avoid or engage with high-emitting companies, while passive funds must hold the index.
...
The data shows that publicly traded equities carry roughly 77% higher absolute financed emissions than long-term bonds, despite both having similar coverage at 98% of AUM — reflecting the higher-carbon composition of the equity portfolio.
