...
The "without undue cost or effort" qualifier acknowledges that perfect information is unavailable. In practice, this means that an entity does not have to conduct exhaustive or expensive research if the cost would heavily outweigh the benefit to investors — but it cannot ignore readily available or clearly material information. An entity is not expected to commission bespoke climate science; it should use publicly available information (IEA scenarios, IPCC reports, regulatory announcements, industry analyses).
