...
<HighlightBox>
**Key takeaway:** Identifying climate-related risks and opportunities under IFRS S2 is not a generic exercise. It requires specific descriptions of each risk and opportunity, a physical or transition classification, time horizon assignment with entity-defined horizon definitions, and reference to sector-specific guidance. The entity must use all reasonably available information, including forward-looking scenario data, to make these assessments.
</HighlightBox>
