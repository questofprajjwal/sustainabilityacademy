...
<FormulaBox>
CO2e = Quantity of gas (tonnes) x Global Warming Potential (GWP)

Example: 10 tonnes of CH4 x 29.8 (GWP100, IPCC AR6) = 298 tCO2e
</FormulaBox>
...
<HighlightBox>
**Key takeaway:** Every entity must disclose absolute gross Scope 1, 2, and 3 emissions in tCO2e using the GHG Protocol as the mandatory basis. Scope 1 covers direct emissions from owned or controlled sources; Scope 2 covers purchased electricity and heat, disclosed on a location-based basis with information about contractual instruments. Entities must choose and disclose an equity share or control consolidation approach, and disaggregate Scope 1 and 2 between the consolidated accounting group and other investees.
</HighlightBox>
