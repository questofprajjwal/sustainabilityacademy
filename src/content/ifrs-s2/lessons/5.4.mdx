...
<HighlightBox>
**Key takeaway:** IFRS S2's illustrative guidance (IE1 to IE24) provides three worked examples of GHG emissions disaggregation (Example 3 covers two industry sub-cases: oil and gas, and automobiles). Example 1 (consolidated group vs investees) is mandatory. The others are discretionary based on materiality. The decision to disaggregate further depends on whether a specific component is large, regulated, targeted, or called for by industry guidance. The worked numerical examples demonstrate the level of precision and comparative period presentation expected.
</HighlightBox>
